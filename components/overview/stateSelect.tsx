...
import { MenuItem, Select, FormControl, InputLabel, FormHelperText, Box, FormLabel } from "@mui/material";
...
type SelectStateComponentProps = {
    control: Control<any>;
...
const SelectStateComponent: React.FC<SelectStateComponentProps> = ({ control, watch, setValue, errors }) => {
    const selectedState = watch("state");

    const getLgaOptions = (): string[] => {
