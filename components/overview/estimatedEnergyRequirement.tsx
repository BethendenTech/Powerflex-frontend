            ...
            <div className="w-full pt-4 pb-4 mb-2">
                ...
                <ul role="list">
                    ...
                    <li className="flex justify-between gap-x-6 py-2">
                        <div className="flex min-w-0 gap-x-4">
                            <div className="min-w-0 flex-auto">
                                <p className="text-sm font-harmonia font-normal leading-[1.3] text-black">Number of batteries</p>
                            </div>
                        </div>
                        <div className="shrink-0 sm:flex sm:flex-col sm:items-end">
                    ...
                    <li className="flex justify-between gap-x-6 py-2">
                        <div className="flex min-w-0 gap-x-4">
                            <div className="min-w-0 flex-auto">
                                <p className="text-sm font-harmonia font-normal leading-[1.3] text-black">Total Load Kwh</p>
                            </div>
                        </div>
                        <div className="shrink-0 sm:flex sm:flex-col sm:items-end">
